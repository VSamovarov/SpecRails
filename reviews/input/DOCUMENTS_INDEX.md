...
Хочешь, я добавлю **мини-скрипт на Node.js** (`/reviews/utils/prepare-index.js`), который сможет автоматически:
- проверить наличие всех файлов из этого списка,
- отметить отсутствующие или новые,
- пересобрать Markdown-оглавление?

Это сильно упростит поддержание `DOCUMENTS_INDEX.md` в актуальном состоянии.
