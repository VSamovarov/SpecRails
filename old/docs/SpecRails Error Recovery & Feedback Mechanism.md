...
7. Если ошибки остаются → Feedback Manager запускает guided re-prompt.
8. **Аналитик** добавляет ручной комментарий при необходимости.
...
| **Semantic**  | Analyst          | Manual / AI-assist | Поле не соответствует бизнес-логике |
